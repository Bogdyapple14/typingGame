...
export class WordServiceService {
  ...
  private texts = [
    ...
    computing result or to perform a specific task. Programming involves tasks such as: analysis, generating algorithms, 
    profiling algorithms' accuracy and resource consumption, and the implementation of algorithms in a chosen programming
     language (commonly referred to as coding).`,
  ];
  private scores: Score[];

  getScore() {
    this.retrieveScoresFromLS();
    return this.scores;
  }
  ...
  retrieveScoresFromLS() {
    if (localStorage.getItem('scores') === null) this.scores = [];
